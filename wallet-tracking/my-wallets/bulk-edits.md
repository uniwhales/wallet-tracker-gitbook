...
To make a bulk edit, click the checkbox in the top left of the screen. This will select all wallets on the page. To select all wallets that you're following, click **Select all XXX of your wallets**:
