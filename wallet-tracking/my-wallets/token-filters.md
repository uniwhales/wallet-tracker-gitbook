...
To set an alert, in **Tracking** click the filter icon for a particular wallet or select all wallets if you want to batch add a token alert.

<figure><img src="../../.gitbook/assets/Screenshot 2025-07-03 at 15.53.32.png" alt="" width="367"><figcaption><p>Click the filter icon on the right to add a token alert</p></figcaption></figure>
