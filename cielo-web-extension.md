...
The Cielo web extension is available as a browser plugin for Chrome and Brave. It can be used to quickly add wallets to Cielo as you’re browsing the web. When using a web3 app such as Etherscan, the Cielo extension superimposes one-click buttons alongside wallet addresses.<br>
